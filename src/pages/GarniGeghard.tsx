  ...
  return (
    <div className="min-h-screen bg-[#0B0F12] text-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            ...
            <div className="rounded-2xl bg-black/20 ring-1 ring-white/15 backdrop-blur p-8 text-center">
              ...
              <p className="text-white/80 leading-relaxed">Маршрутка до Гарни от станции метро Гарегин Нжде — 300 драм. Из Гарни до Гегарда — такси ~1500 драм.</p>
            </div>
            <div className="rounded-2xl bg-black/20 ring-1 ring-white/15 backdrop-blur p-8 text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-black/30 ring-1 ring-white/20 mb-6">
              ...
              <div className="rounded-2xl bg-white/95 text-black p-8 shadow-2xl">
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea id="message" rows={5} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none" placeholder="Ваши вопросы о посещении Гарни и Гегарда или ваш опыт..." />
                  </div>
      ...
      <section className="relative z-10 py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <Link to="/housing/garni" className="group block rounded-3xl bg-white/5 ring-1 ring-white/10 hover:ring-white/30 transition-all duration-300 p-10 md:p-14">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="text-white/50 text-sm mb-1">Гарни</p>
                  <h3 className="text-2xl md:text-3xl font-semibold">Где остановиться и поесть</h3>
                  <p className="text-white/60 mt-2">Жильё и кафе в деревне у античного храма</p>
                </div>
              </div>
