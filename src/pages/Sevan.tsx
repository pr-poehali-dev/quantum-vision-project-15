...
const Sevan = () => {
  ...
  const faqs: FAQ[] = [
    {
      question: "Что такое озеро Севан?",
      answer:
        "Севан — одно из крупнейших высокогорных озёр мира, расположенное на высоте 1900 метров над уровнем моря. Его называют «жемчужиной Армении» и «Высокогорным морем». Кристально чистая вода и окружающие горы создают непередаваемую атмосферу.",
    },
    {
      question: "Что такое севанский сиг и где его попробовать?",
      answer:
        "Севанский сиг (ишхан — «форель-принц») — эндемичная рыба, обитающая только в озере Севан. Считается деликатесом армянской кухни. В рамках тура мы посещаем лучшие рыбные рестораны на берегу озера, где подают свежайшего сига.",
    },
    {
      question: "Что такое монастырь Севанаванк?",
      answer:
        "Севанаванк — монастырь IX века на живописном полуострове, возвышающийся над озером. Раньше он стоял на острове, но понижение уровня воды превратило остров в полуостров. Подъём к монастырю открывает захватывающую панораму всего озера.",
    },
    {
    ...
    <div className="min-h-screen bg-[#0B0F12] text-white">
      <div className="relative min-h-screen">
        <div
          ...
          style={{
            backgroundImage: "url(https://cdn.poehali.dev/projects/9e095471-aeb3-4da6-9822-948a31d93712/files/50061a3c-55f5-4cd7-9c62-6bb2bcda66a7.jpg)",
          }}
        >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-120px)] px-6 text-center">
          <div className="mb-6 px-4 py-2 bg-black/40 ring-1 ring-white/20 backdrop-blur rounded-full">
            <span className="text-sm font-medium">Высокогорное море Армении</span>
          </div>
          <h1 className="text-6xl md:text-8xl font-light tracking-tight mb-6 text-balance">Севан</h1>
          <p className="text-xl md:text-2xl text-white/90 max-w-4xl mb-12 leading-relaxed text-pretty">
            Поднимитесь к монастырю Севанаванк, чтобы увидеть бескрайнюю лазурь озера. Попробуйте знаменитого севанского сига и подышите чистым горным воздухом на высоте 1900 метров.
          </p>
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-black/40 ring-1 ring-white/20 backdrop-blur rounded-full">
            ...
            <span className="text-sm font-medium">1900 м над уровнем моря</span>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            <div className="rounded-2xl bg-black/20 ring-1 ring-white/15 backdrop-blur p-8 text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">1900 м высоты</h3>
              <p className="text-white/80 leading-relaxed">Одно из крупнейших высокогорных озёр мира с кристальной водой.</p>
            </div>
            <div className="rounded-2xl bg-black/20 ring-1 ring-white/15 backdrop-blur p-8 text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-black/30 ring-1 ring-white/20 mb-6">
                <Icon name="ShieldCheck" size={24} />
              </div>
              <h3 className="text-xl font-semibold mb-4">Севанаванк</h3>
              <p className="text-white/80 leading-relaxed">Монастырь IX века с захватывающей панорамой озера.</p>
            </div>
            <div className="rounded-2xl bg-black/20 ring-1 ring-white/15 backdrop-blur p-8 text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-black/30 ring-1 ring-white/20 mb-6">
                <Icon name="Utensils" size={24} />
              </div>
              <h3 className="text-xl font-semibold mb-4">Севанский сиг</h3>
              <p className="text-white/80 leading-relaxed">Эндемичная рыба-деликатес — обязательное блюдо на берегу озера.</p>
            </div>
            <div className="rounded-2xl bg-black/20 ring-1 ring-white/15 backdrop-blur p-8 text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-black/30 ring-1 ring-white/20 mb-6">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="rounded-3xl bg-white/5 ring-1 ring-white/10 backdrop-blur p-12">
            <div className="text-center mb-16">
              <h2 className="text-5xl md:text-6xl font-bold tracking-tight mb-6 text-balance">Ваш день на Севане</h2>
              <p className="text-xl text-white/80 max-w-3xl mx-auto text-pretty">Природа, история и гастрономия в одном маршруте.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 backdrop-blur p-8 h-80 flex flex-col">
                <div className="flex-1">
                  ...
                  <p className="text-white/80 leading-relaxed text-sm">Дорога через горный перевал с видами на Аразанскую долину и первые панорамы озера.</p>
                </div>
              </div>
              <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 backdrop-blur p-8 h-80 flex flex-col">
                <div className="flex-1">
                  ...
                  <h3 className="text-xl font-semibold mb-4">Севанаванк</h3>
                  <p className="text-white/80 leading-relaxed text-sm">Подъём к монастырю, осмотр церквей IX века и бескрайняя панорама лазурного озера.</p>
                </div>
              </div>
              <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 backdrop-blur p-8 h-80 flex flex-col">
                <div className="flex-1">
                  <div className="text-3xl font-bold text-white/60 mb-4">03.</div>
                  <h3 className="text-xl font-semibold mb-4">Обед с видом</h3>
                  <p className="text-white/80 leading-relaxed text-sm">Свежайший севанский сиг в ресторане прямо на берегу озера с видом на горы.</p>
                </div>
              </div>
              <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 backdrop-blur p-8 h-80 flex flex-col">
                <div className="flex-1">
                  <div className="text-3xl font-bold text-white/60 mb-4">04.</div>
                  <h3 className="text-xl font-semibold mb-4">Прогулка по берегу</h3>
                  <p className="text-white/80 leading-relaxed text-sm">Свободное время у воды, фотографии и чистый горный воздух перед возвращением.</p>
                </div>
              </div>
            </div>
          ...
          <div className="rounded-3xl bg-white/5 ring-1 ring-white/10 backdrop-blur p-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-xl text-white/80 leading-relaxed text-pretty">Всё, что нужно знать о поездке на высокогорное озеро Севан.</p>
              </div>
      ...
      <section className="relative z-10 py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <Link to="/housing/sevan" className="group block rounded-3xl bg-white/5 ring-1 ring-white/10 hover:ring-white/30 transition-all duration-300 p-10 md:p-14">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="text-white/50 text-sm mb-1">Севан</p>
                  <h3 className="text-2xl md:text-3xl font-semibold">Где остановиться и поесть</h3>
                  <p className="text-white/60 mt-2">Жильё у озера и рестораны с севанским сигом</p>
                </div>
              </div>
