        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            ...
            <div className="rounded-2xl bg-black/20 ring-1 ring-white/15 backdrop-blur p-8 text-center">
              ...
              <p className="text-white/80 leading-relaxed">Трансфер из Еревана, гид и входные билеты в монастырь.</p>
            </div>
            <div className="rounded-2xl bg-black/20 ring-1 ring-white/15 backdrop-blur p-8 text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-black/30 ring-1 ring-white/20 mb-6">
          ...
          <div className="rounded-3xl bg-black/20 ring-1 ring-white/15 backdrop-blur p-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div className="rounded-2xl bg-white/95 text-black p-8 shadow-2xl">
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea id="message" rows={5} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none" placeholder="Ваши вопросы о туре в Хор Вирап..." />
                  </div>
              ...
              <div className="space-y-8">
                <p className="text-xl text-white/90 leading-relaxed text-pretty">По вопросам экскурсий в Хор Вирап, групповых туров или индивидуальных программ — свяжитесь с нами. Отвечаем в течение одного рабочего дня.</p>
