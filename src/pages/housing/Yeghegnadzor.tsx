  ...
  return (
    <div className="min-h-screen bg-[#0B0F12] text-white">
      <nav className="flex items-center justify-between p-6 border-b border-white/10">
        <Link to="/noravank" className="flex items-center gap-2 px-4 py-2 bg-black/40 ring-1 ring-white/20 backdrop-blur rounded-full hover:bg-black/50 transition-colors">
          <Icon name="ArrowLeft" size={16} />
          <span className="font-medium">Назад к Нораванку</span>
        </Link>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="mb-4 inline-flex items-center gap-2 px-4 py-2 bg-white/5 ring-1 ring-white/15 rounded-full text-sm text-white/70">
          ...
          Ехегнадзор (Вайоц Дзор)
        </div>
        <h1 className="text-5xl md:text-6xl font-light tracking-tight mb-6">Где остановиться<br />и поесть</h1>
        <p className="text-xl text-white/70 leading-relaxed">
          Здесь скоро появится подробная информация о жилье и ресторанах Ехегнадзора и окрестностей — идеальной базы для посещения Нораванка и виноградников Арени.
        </p>
      </div>
