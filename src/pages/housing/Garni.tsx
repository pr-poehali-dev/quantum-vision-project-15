  ...
  return (
    <div className="min-h-screen bg-[#0B0F12] text-white">
      <nav className="flex items-center justify-between p-6 border-b border-white/10">
        <Link to="/garni-geghard" className="flex items-center gap-2 px-4 py-2 bg-black/40 ring-1 ring-white/20 backdrop-blur rounded-full hover:bg-black/50 transition-colors">
          <Icon name="ArrowLeft" size={16} />
          <span className="font-medium">Назад к Гарни и Гегарду</span>
        </Link>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p className="text-xl text-white/70 leading-relaxed">
          Здесь скоро появится подробная информация о жилье и кафе в Гарни — небольшой деревне у античного храма, откуда удобно посещать и Гегард.
        </p>
      </div>
